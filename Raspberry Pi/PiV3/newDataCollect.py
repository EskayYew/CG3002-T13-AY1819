...
class Pi:
    ...
    def read_data(self):
        ...
        self.currentData = self.data_buff.copy()
        ...
        try:
            ...
            while True:
                ...
                if(self.currentData is not None):
                    myFile.write(self.currentData)
                    self.counter += 1

                if(self.counter % 50 == 0):
                    print('Current Size :', self.counter)

                if(self.counter is self.WINDOWSIZE):
                    myFile.close()
                    print(self.counter, 'sets of data is written into csv')
                    print("Writing complete & Program End")
                    sys.exit(1)
